...
import { Card, Dropdown, Form, Button, Menu, Input, Label } from "semantic-ui-react"
          ...
          <Menu >
            <Form style={{ marginLeft: 5 + "px", padding: 5 + "px" }}>
              <Form.Field inline>
                ...
                <input type='text' placeholder='Location' value={this.state.locationSearch}
                  onChange={event => {
            ...
            <Form style={{ marginLeft: 5 + "px", padding: 5 + "px" }}>
              <Form.Field inline>
                ...
                <input type='Number' placeholder={0} value={this.state.pubNumberSearch}
                  onChange={event => {
